...
static inline SEXP bitmask_new(int64_t size) {
  ...
  Rf_setAttrib(bitmask, R_ClassSymbol, Rf_mkString("arch_bitmask"));
  UNPROTECT(1);
  return bitmask;
}
...
SEXP arch_c_logical_from_bitmask(SEXP bitmask, SEXP start_sexp, SEXP end_sexp) {
...
SEXP arch_c_bitmask_from_logical(SEXP lgl_sexp) {
