...
SEXP arch_c_double_from_int64(SEXP value, SEXP start_sexp, SEXP end_sexp) {
...
SEXP arch_c_int64_from_double(SEXP dbl_sexp) {
  ...
  Rf_setAttrib(int64_sexp, R_ClassSymbol, Rf_mkString("arch_int64"));
  UNPROTECT(1);
  return int64_sexp;
}

SEXP arch_c_int64_from_integer(SEXP int_sexp) {
