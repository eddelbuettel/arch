...
extern "C" {
    ...
    static inline SEXP attribute_hidden arch_c_array_from_sexp(SEXP buffers_sexp, SEXP length_sexp,
    ...
    static inline SEXP attribute_hidden arch_c_array_info(SEXP array_data_xptr) {
        static SEXP(*fun)(SEXP) = (SEXP(*)(SEXP)) R_GetCCallable("arch","arch_c_array_info");
        return fun(array_data_xptr);
    }

    static inline SEXP attribute_hidden arch_c_arch_array_stream(SEXP array_list, SEXP schema_xptr) {
        static SEXP(*fun)(SEXP,SEXP) = (SEXP(*)(SEXP,SEXP)) R_GetCCallable("arch","arch_c_arch_array_stream");
        return fun(array_list, schema_xptr);
    }

    static inline SEXP attribute_hidden arch_c_function_array_stream(SEXP schema_xptr, SEXP call, SEXP env) {
    ...
    static inline SEXP attribute_hidden arch_c_export_array_stream(SEXP parent_xptr, SEXP xptr_dst) {
        static SEXP(*fun)(SEXP,SEXP) = (SEXP(*)(SEXP,SEXP)) R_GetCCallable("arch","arch_c_export_array_stream");
        return fun(parent_xptr, xptr_dst);
    }

    static inline SEXP attribute_hidden arch_c_arch_array_stream_get_schema(SEXP xptr) {
        static SEXP(*fun)(SEXP) = (SEXP(*)(SEXP)) R_GetCCallable("arch","arch_c_arch_array_stream_get_schema");
        return fun(xptr);
    }

    static inline SEXP attribute_hidden arch_c_arch_array_stream_get_next(SEXP xptr) {
        static SEXP(*fun)(SEXP) = (SEXP(*)(SEXP)) R_GetCCallable("arch","arch_c_arch_array_stream_get_next");
        return fun(xptr);
    }

    static inline SEXP attribute_hidden arch_c_validate(SEXP array_sexp) {
        static SEXP(*fun)(SEXP) = (SEXP(*)(SEXP)) R_GetCCallable("arch","arch_c_validate");
        return fun(array_sexp);
    }

    static inline SEXP attribute_hidden arch_c_logical_from_bitmask(SEXP bitmask, SEXP start_sexp, SEXP end_sexp) {
    ...
    static inline SEXP attribute_hidden arch_c_bitmask_from_logical(SEXP sexp) {
        static SEXP(*fun)(SEXP) = (SEXP(*)(SEXP)) R_GetCCallable("arch","arch_c_bitmask_from_logical");
        return fun(sexp);
    }

    static inline SEXP attribute_hidden arch_c_logical_from_array(SEXP sexp) {
        static SEXP(*fun)(SEXP) = (SEXP(*)(SEXP)) R_GetCCallable("arch","arch_c_logical_from_array");
        return fun(sexp);
    }

    static inline SEXP attribute_hidden arch_c_integer_from_array(SEXP sexp) {
        static SEXP(*fun)(SEXP) = (SEXP(*)(SEXP)) R_GetCCallable("arch","arch_c_integer_from_array");
        return fun(sexp);
    }

    static inline SEXP attribute_hidden arch_c_double_from_array(SEXP sexp) {
        static SEXP(*fun)(SEXP) = (SEXP(*)(SEXP)) R_GetCCallable("arch","arch_c_double_from_array");
        return fun(sexp);
    }

    static inline SEXP attribute_hidden arch_c_raw_from_array(SEXP sexp) {
        static SEXP(*fun)(SEXP) = (SEXP(*)(SEXP)) R_GetCCallable("arch","arch_c_raw_from_array");
        return fun(sexp);
    }

    static inline SEXP attribute_hidden arch_c_character_from_array(SEXP sexp) {
        static SEXP(*fun)(SEXP) = (SEXP(*)(SEXP)) R_GetCCallable("arch","arch_c_character_from_array");
        return fun(sexp);
    }

    static inline SEXP attribute_hidden arch_c_buffers_from_character(SEXP chr) {
        static SEXP(*fun)(SEXP) = (SEXP(*)(SEXP)) R_GetCCallable("arch","arch_c_buffers_from_character");
        return fun(chr);
    }

    static inline SEXP attribute_hidden arch_c_deep_copy(SEXP sexp) {
        static SEXP(*fun)(SEXP) = (SEXP(*)(SEXP)) R_GetCCallable("arch","arch_c_deep_copy");
        return fun(sexp);
    }

    static inline SEXP attribute_hidden arch_c_double_from_int64(SEXP value, SEXP start_sexp, SEXP end_sexp) {
    ...
    static inline SEXP attribute_hidden arch_c_schema_deep_copy(SEXP schema_xptr) {
        static SEXP(*fun)() = (SEXP(*)()) R_GetCCallable("arch","arch_c_schema_deep_copy");
        return fun();
    }

    static inline SEXP attribute_hidden arch_c_schema_data(SEXP schema_xptr) {
        static SEXP(*fun)() = (SEXP(*)()) R_GetCCallable("arch","arch_c_schema_data");
        return fun();
    }

    static inline SEXP attribute_hidden  arch_c_xptr_addr(SEXP xptr) {
